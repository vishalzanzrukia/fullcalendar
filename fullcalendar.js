...
function DayEventRenderer() {
	...
	function buildHTMLForSegment(segment) {
		...
		if(event.isHoliday){
			cssClassTemp = "is-holiday";
			titleTemp = "HOLIDAY";
		}
		else{
			cssClassTemp = event.attendence.cssClass;
			titleTemp = event.attendence.status;
			
			if(!(event.leave=="" || event.leave==null || event.leave=="undefined" || event.leave==undefined))
			{
				if(event.leave.hasOwnProperty("cssClass"))
				{
					//console.log("true : " + event.leave.cssClass);
					hasLeave = "<span class='is-leave fa "+event.leave.cssClass+"'></span>";	
				}
			}
		}
		...
		html +=
			" class='"+cssClassTemp+" "+classNames.join(' ') + "'" +
			" style=" +
				"'" +
				"position:absolute;" +
				...
				"'" +
			">" +
			"<div class='fc-event-inner'>"+hasLeave;
